#gateway.client.javascript.util

##Installing Dependencies
Before you can build gateway.client.javascript.util, you must install and configure the following dependencies on your machine:
